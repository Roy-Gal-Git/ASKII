...
- **output_dir**: Directory where the code task file will be created (default: ".sop/planning")
- **task_name**: For descriptions only - specific task name. If not provided, will be generated from the description.
